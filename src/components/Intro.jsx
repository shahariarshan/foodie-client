...
const Intro = () => {
    return (
        <div className="max-w-screen-2xl mt-24 container mx-auto md:px-24  bg-gradient-to-r from-[#FAFAFA] from-0% to-[#FCFCFC] t0-[100%]" >
            <div className="flex flex-col lg:flex-row-reverse item-center gap-8 justify-between ">
                <div className="lg:w-1/2 ">
                    ...
                    <div className="flex hover:-translate-y-3 duration-100 transition-all flex-col md:flex-row justify-around -mt-16 ">
                        {/* 1 */}
                ...
                <div className="lg:w-1/2 space-y-12 lg:mt-28">
